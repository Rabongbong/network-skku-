...
def runMininet():
    ...
    myTopo = Assignment3Topo(bw_v = 10, delay_v='25ms', loss_v=int(sys.argv[4]))  #make test network topology
    #myTopo = Assignment3Topo(bw_v = 10, delay_v='25ms', loss_v=4)  #make test network topology
